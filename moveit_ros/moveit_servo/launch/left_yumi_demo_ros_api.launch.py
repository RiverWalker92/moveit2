...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("yumi", package_name="left_yumi_moveit_config")
    ...
    ####### RViz #######
    rviz_config_file = (
        get_package_share_directory("left_yumi_moveit_config")
        + "/config/moveit.rviz"
    )
    ...
    ros2_control_node = launch_ros.actions.Node(
        ...
        remappings=[
            ("/left_controller_manager/robot_description", "/robot_description"),
        ],
        output="screen",
    )
    ...
    servo_params = {
        ...
        .yaml("config/left_yumi_simulated_config.yaml")
        .to_dict()
    }
    ...
    container = launch_ros.actions.ComposableNodeContainer(
        name="left_moveit_servo_demo_container",
        namespace="/",
        ...
        composable_node_descriptions=[
            ...
            launch_ros.descriptions.ComposableNode(
                ...
                parameters=[{"child_frame_id": "/yumi_base_link", "frame_id": "/world"}],
            ),
        ],
        output="screen",
    )
